...
- Spectral dimension (d_S, from random walk return probabilities).

Save results to `gauge_trajectories.csv`.
...
| Metric              | Expected Average | Expected Error |
|---------------------|------------------|----------------|
| 3-Cycle Count       | 42               | 2              |
| Curvature Average   | 0.05             | 0.01           |
| Spectral Dimension  | 3.98             | 0.05           |
