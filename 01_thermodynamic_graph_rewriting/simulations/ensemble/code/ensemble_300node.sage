...
# Subject:      Statistical Ensemble Analysis at N=300
# Author:       R. Fisher
...
# Reproducibility: Seed 42; ~320s for 5000 runs on Ryzen 5/16GB.
# -----------------------------------------------------------------------------
...
ENSEMBLE_CONFIG = {
    "NUM_RUNS": 5000,
    "NUM_NODES_APPROX": 300,
    "SIMULATION_STEPS": 2000,
    "ALPHA": 1.0,
    "SEED": 42,
    "VERSION_CHECK": "1.0",
    "OUTPUT_DIR": "./outputs",
    "CSV_OUTPUT": "ensemble_N300_data.csv",
    "STATS_OUTPUT": "ensemble_N300_summary.txt",
    "PLOT_OUTPUT": "ensemble_N300_histogram.pdf",
}
