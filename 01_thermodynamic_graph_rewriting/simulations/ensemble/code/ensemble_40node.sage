...
# Subject:      Statistical Ensemble Analysis at N=40
# Author:       R. Fisher
...
# Reproducibility: Seed 42; ~30s for 5000 runs on Ryzen 5/16GB.
# -----------------------------------------------------------------------------
...
ENSEMBLE_CONFIG = {
    ...
    "VERSION_CHECK": "1.0",
    "OUTPUT_DIR": "./outputs",
    "CSV_OUTPUT": "ensemble_N40_data.csv",
    "STATS_OUTPUT": "ensemble_N40_summary.txt",
    "PLOT_OUTPUT": "ensemble_N40_histogram.pdf",
}
