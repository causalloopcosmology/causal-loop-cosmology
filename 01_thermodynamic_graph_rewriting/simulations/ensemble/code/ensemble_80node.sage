...
# Subject:      Statistical Ensemble Analysis at N=80
# Author:       R. Fisher
...
# Reproducibility: Seed 42; ~75s for 5000 runs on Ryzen 5/16GB.
# -----------------------------------------------------------------------------
...
ENSEMBLE_CONFIG = {
    ...
    "VERSION_CHECK": "1.0",
    "OUTPUT_DIR": "./outputs",
    "CSV_OUTPUT": "ensemble_N80_data.csv",
    "STATS_OUTPUT": "ensemble_N80_summary.txt",
    "PLOT_OUTPUT": "ensemble_N80_histogram.pdf",
}
