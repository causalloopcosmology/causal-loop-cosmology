...
# Subject:      Statistical Ensemble Analysis at N=2240
# Author:       R. Fisher
...
# Reproducibility: Seed 42; ~3150s for 5000 runs on Ryzen 5/16GB.
# -----------------------------------------------------------------------------
...
ENSEMBLE_CONFIG = {
    "NUM_RUNS": 5000,
    "NUM_NODES_APPROX": 2240,
    "SIMULATION_STEPS": 2000,
    "ALPHA": 1.0,
    "SEED": 42,
    "VERSION_CHECK": "1.0",
    "OUTPUT_DIR": "./outputs",
    "CSV_OUTPUT": "ensemble_N2240_data.csv",
    "STATS_OUTPUT": "ensemble_N2240_summary.txt",
    "PLOT_OUTPUT": "ensemble_N2240_histogram.pdf",
}
