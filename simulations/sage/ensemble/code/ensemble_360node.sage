...
# Subject:      Statistical Ensemble Analysis at N=360
# Author:       R. Fisher
...
# Reproducibility: Seed 42; ~390s for 5000 runs on Ryzen 5/16GB.
# -----------------------------------------------------------------------------
...
ENSEMBLE_CONFIG = {
    "NUM_RUNS": 5000,
    "NUM_NODES_APPROX": 360,
    "SIMULATION_STEPS": 2000,
    "ALPHA": 1.0,
    "SEED": 42,
    "VERSION_CHECK": "1.0",
    "OUTPUT_DIR": "./outputs",
    "CSV_OUTPUT": "ensemble_N360_data.csv",
    "STATS_OUTPUT": "ensemble_N360_summary.txt",
    "PLOT_OUTPUT": "ensemble_N360_histogram.pdf",
}
