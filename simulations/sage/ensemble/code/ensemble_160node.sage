...
# Subject:      Statistical Ensemble Analysis at N=160
# Author:       R. Fisher
...
# Reproducibility: Seed 42; ~160s for 5000 runs on Ryzen 5/16GB.
# -----------------------------------------------------------------------------
...
ENSEMBLE_CONFIG = {
    "NUM_RUNS": 5000,
    "NUM_NODES_APPROX": 160,
    "SIMULATION_STEPS": 2000,
    "ALPHA": 1.0,
    "SEED": 42,
    "VERSION_CHECK": "1.0",
    "OUTPUT_DIR": "./outputs",
    "CSV_OUTPUT": "ensemble_N160_data.csv",
    "STATS_OUTPUT": "ensemble_N160_summary.txt",
    "PLOT_OUTPUT": "ensemble_N160_histogram.pdf",
}
